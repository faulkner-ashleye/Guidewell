...
const TIMELINE_PRESETS = [
  { id: 'short' as Timeframe, label: 'Short (1 year)', months: 12 },
  { id: 'mid' as Timeframe, label: 'Medium (5 years)', months: 60 },
  { id: 'long' as Timeframe, label: 'Long (10 years)', months: 120 },
